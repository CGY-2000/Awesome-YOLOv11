...
if __name__ == '__main__':
    model_path = '/home/ubuntu/code/CGY/ultralytics-yolo11/runs/train/visdrone2019/11s-p2/weights/best_fp32.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data='/home/ubuntu/code/CGY/CGY_Datasets/visdrone2019/data.yaml',
                        ...
                        project='/home/ubuntu/code/CGY/ultralytics-yolo11/runs/train/visdrone2019/11s-p2',
                        name='test',
                        )
